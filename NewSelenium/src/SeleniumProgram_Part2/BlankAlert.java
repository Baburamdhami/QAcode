...
package SeleniumProgram_Part2;

//Importing different classes (Alert, By, WebDriver, ChromeDriver)
...
public class BlankAlert {
	...
	public static void main(String[] args) throws InterruptedException {
		 ...
		 WebDriver browserObject; //Create 'browserObject' object for 'WebDriver' class
